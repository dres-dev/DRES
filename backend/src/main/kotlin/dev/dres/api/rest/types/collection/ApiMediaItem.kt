 ...
 * @version 1.1.0
 */
data class ApiMediaItem(val id: String= EvaluationId.EMPTY.string, val name: String, val type: ApiMediaType, val collectionId: String, val location: String, val durationMs: Long? = null, val fps: Float? = null) {
    init {
