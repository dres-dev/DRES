...
enum class ApiSubmissionOption {
    ...
    /**
     * Converts this [ApiSubmissionOption] to a [SubmissionOption] representation. Requires an ongoing transaction.
     *
     * @return [SubmissionOption]
     */
    fun toSubmissionOption(): SubmissionOption = when(this) {
