 ...
 * @param offset Time in seconds after which this [ContentElement] should be displayed.
 */
data class ContentElement(val contentType: ContentType, val content: String? = null, val offset: Long)