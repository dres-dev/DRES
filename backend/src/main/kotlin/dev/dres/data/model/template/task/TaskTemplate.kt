 ...
 * @author Ralph Gasser
 */
class TaskTemplate(entity: Entity) : PersistentEntity(entity), TaskScorerFactory, SubmissionFilterFactory {
    companion object: XdNaturalEntityType<TaskTemplate>()

    /** The [TemplateId] of this [TaskTemplate]. */
    ...
    /** The [TaskGroup] this [TaskTemplate] belongs to. */
    ...
    /**
     * Produces a Textual description of the content of the [TaskTemplate] if possible
     *
     * @return Textual description of this [TaskTemplate]'s content,
     */
