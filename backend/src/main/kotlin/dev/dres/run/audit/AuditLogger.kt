...
object AuditLogger {
     ...
     */
    fun competitionStart(evaluationId: EvaluationId, description: EvaluationTemplate, api: AuditLogSource, session: SessionToken?) {
        AuditLogEntry.new {
     ...
     * @param session The identifier of the user session.
     */
    fun competitionEnd(evaluationId: EvaluationId, api: AuditLogSource, session: SessionToken?) {
        AuditLogEntry.new {
     ...
     * @param session The identifier of the user session.
     */
    fun taskStart(evaluationId: EvaluationId, taskId: EvaluationId, description: TaskTemplate, api: AuditLogSource, session: SessionToken?) {
        AuditLogEntry.new {
     ...
     */
    fun submission(submission: Submission, api: AuditLogSource, sessionToken: SessionToken?, address: String) {
        AuditLogEntry.new {
     ...
     * @param sessionToken The identifier of the user session.
     */
    fun overrideSubmission(submission: Submission, api: AuditLogSource, sessionToken: SessionToken?) {
        this.store.transactional {
            AuditLogEntry.new {
     ...
     * @param sessionToken The identifier of the user session.
     */
    fun judgement(evaluationId: EvaluationId, validator: JudgementValidator, token: String, verdict: VerdictStatus, api: AuditLogSource, sessionToken: SessionToken?) {
        AuditLogEntry.new {
