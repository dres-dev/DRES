 ...
 * The new AVS Scorer.
 */
class NewAvsTaskScorer(override val scoreable: Scoreable, private val penaltyConstant: Double, private val maxPointsPerTask: Double) : TaskScorer {
    ...
    /**
     * Computes and returns the scores for this [NewAvsTaskScorer]. Requires an ongoing database transaction.
     *
