...
interface TaskScorer {
     ...
     */
    fun scores(submissions: Sequence<Submission>): List<ScoreEntry> = this.scoreMap(submissions).map { ScoreEntry(it.key, null, it.value) }
     ...
     */
    fun scoreMap(submissions: Sequence<Submission>): Map<TeamId, Double>
}