...
object Cli {
    ...
    fun loop(dataAccessLayer: DataAccessLayer, config: Config) {
        ...
        val clikt = DRESBaseCommand().subcommands(CompetitionCommand(dataAccessLayer.competitions, dataAccessLayer.collections, config), UserCommand(), MediaCollectionCommand(dataAccessLayer.collections, dataAccessLayer.mediaItems, dataAccessLayer.mediaSegments), CompetitionRunCommand(dataAccessLayer.runs))
