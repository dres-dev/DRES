...
data class QueryResultLog internal constructor(val team: Int, val member: Long, val timestamp: Long, val usedCategories: List<String>,
    ...
    @JsonCreator constructor(
            ...
            @JsonProperty("results") results: List<QueryResult> = emptyList()) : this (team, member, timestamp, usedCategories, usedTypes, sortType, resultSetAvailability, results, System.currentTimeMillis())
