...
data class SubmissionAuditLogEntry(override var id: Long, val competition: String, val taskName: String, val submission: Submission, val api: LogEventSource, val user: String?) : AuditLogEntry(AuditLogEntryType.SUBMISSION){
    constructor(competition: String, taskName: String, submission: Submission, api: LogEventSource, user: String?): this(-1, competition, taskName, submission, api, user)
}
