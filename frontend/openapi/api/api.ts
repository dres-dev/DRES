...
export const APIS = [CollectionService, CompetitionService, CompetitionRunService, CompetitionRunAdminService, DefaultService, JudgementService, MediaService, SubmissionService, UserService];
