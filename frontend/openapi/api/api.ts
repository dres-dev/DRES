...
export const APIS = [CollectionService, CompetitionService, CompetitionRunService, DefaultService, JudgementService, MediaService, SubmissionService, UserService];
