...
export class CompetitionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postApiCompetitionStart(competitionStart?: CompetitionStart, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<SuccessStatus>;
    public postApiCompetitionStart(competitionStart?: CompetitionStart, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<SuccessStatus>>;
    public postApiCompetitionStart(competitionStart?: CompetitionStart, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<SuccessStatus>>;
    public postApiCompetitionStart(competitionStart?: CompetitionStart, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<SuccessStatus>(`${this.configuration.basePath}/api/competition/start`,
            competitionStart,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
