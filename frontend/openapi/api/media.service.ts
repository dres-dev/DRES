...
export class MediaService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getApiMediaWithCollectionWithItem(collection: string, item: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<any>;
    public getApiMediaWithCollectionWithItem(collection: string, item: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpResponse<any>>;
    public getApiMediaWithCollectionWithItem(collection: string, item: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpEvent<any>>;
    public getApiMediaWithCollectionWithItem(collection: string, item: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined}): Observable<any> {
        if (collection === null || collection === undefined) {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/api/media/${encodeURIComponent(String(collection))}/${encodeURIComponent(String(item))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
