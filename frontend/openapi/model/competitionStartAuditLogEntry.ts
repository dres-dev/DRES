...
export interface CompetitionStartAuditLogEntry { 
    type: CompetitionStartAuditLogEntry.TypeEnum;
    timestamp: number;
    timestamp$backend?: number;
    id_1rSl5jE: string;
    id_Fwp7XY8?: string;
    api: CompetitionStartAuditLogEntry.ApiEnum;
    user?: string;
    competition_1rSl5jE: string;
}
export namespace CompetitionStartAuditLogEntry {
