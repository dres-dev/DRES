...
export interface JudgementAuditLogEntryAllOf { 
    validator?: string;
    token?: string;
    verdict?: JudgementAuditLogEntryAllOf.VerdictEnum;
    api?: JudgementAuditLogEntryAllOf.ApiEnum;
    user?: string;
    competition_1rSl5jE?: string;
}
export namespace JudgementAuditLogEntryAllOf {
